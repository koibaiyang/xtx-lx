...
<template>
  ...
  <el-dialog title="切换收货地址" width="30%" center v-model="dialogVisible">
    <div class="addressWrapper">
      <div class="text item" :class="{active: item.id === activeAddress.id}" @click="active(item)" v-for="item in checkInfo.userAddresses" :key="item.id">
        <ul>
    ...
    <template #footer>
      <span class="dialog-footer">
        ...
        <el-button type="primary" @click="confirmActive">确定</el-button>
      </span>
    </template>
  </el-dialog>
  <!-- 添加地址 -->
