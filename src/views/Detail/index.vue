<script setup>
import { getGoodsDetailAPI } from '@/apis/goodsDetail.js'
...
const addCart = () => {
  if (skuGoods.value.skuId) {
    ...
    cartStore.addCount({
      ...
      count: count.value,
      skuId: skuGoods.value.skuId,
      attrsText: skuGoods.value.specsText,
      selected: true,
    })
  } else {
    ElMessage({
...
<template>
  <div class="xtx-goods-page" v-if="goodsDetail.categories">
    <div class="container">
      ...
      <div class="info-container">
        <div>
          <div class="goods-info">
            <div class="media">
              <!-- 图片预览区 -->
              <ImgChange :imageList="goodsDetail.mainPictures"></ImgChange>
              <!-- 统计数量 -->
            ...
            <div class="spec">
              ...
              <!-- sku组件 -->
              <XtxSku :goods="goodsDetail" @change="getSku"></XtxSku>
